...
const RULES = [
   ...
   */
  /*
   * Трейдер: смотреть цены может кто угодно из команды, править — нет. Правки
   * идут в файлы работающего сервера, поэтому право отдельное.
   */
  ['GET', '/trader', 'trader.view'],
  ['GET', '/trader/products', 'trader.view'],
  ['GET', '/trader/validate', 'trader.view'],
  ['POST', '/trader/backup', 'trader.manage'],
  ['POST', /^\/trader\//, 'trader.manage'],
